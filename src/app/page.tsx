...
import Superiority from "@/components/Hero/Superiority";
import { cn } from "@/lib/utils";
import { imageUsers, superiorities } from "@/utils/landing-page";
                  ...
                  {imageUsers.map((img, i) => {
                    ...
                    return (
                      <Image
                        ...
                        width={40}
                        className={cn(
                          "inline-block rounded-full ring-2 ring-slate-100",
                          {
